...
import static Methods_servises.Testing_methods.Switch_Selector;
...
public class B4_material_requests_ADD_p {
    private WebDriver d;
    ...
    private By select_material_request_type_filed= By.xpath("//ul[@id=\"select2-req_type-results\"]//li");

    public B4_material_requests_ADD_p(WebDriver d) {
        this.d = d;
    }
    ...
    public B1_AddSite_p click_Add_newMaterial_Permit() {
...
//    public void select_material_request_type(String material_request_type) {
//        Switch_Selector(d,select_material_request_type_filed,material_request_type);
//    }
