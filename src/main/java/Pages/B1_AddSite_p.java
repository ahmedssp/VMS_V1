...
public class B1_AddSite_p {
    ...
    public B1_AddSite_p(WebDriver d) {
        this.d = d;
    }
    ...
    public void SendTime(String Staringdate, String endDate) {
    ...
    public String Aleart_Messegs_StartingTime() {
        ...
        try {
            waitForElement(d, Aleart_Messegs_StartingTime_Field);
    ...
    public String Aleart_Messegs_LocationNamew() {
        ...
        try {
            waitForElement(d, Aleart_Messegs_LocationNamew_Field);
            Reporter.log(new Object() {
            }.getClass().getEnclosingMethod().getName() + PassMessege);
