...
public class B4_Visits_requests_ADD_p {
    private WebDriver d;
    ...
    public B4_Visits_requests_ADD_p(WebDriver d) {
        this.d = d;
    }
    ...
    public void click_Add_newVisitor() {
...
//    public void Switch_Selector(WebDriver driver,By  locator,String SearchInputWord){
//        try {
...
//    }
    ...
    public void Click_SelectVisitor2(String visitorname) {

        Methods_servises.Testing_methods.Switch_Selector(d,Click_filedofinput_Visitor_list,visitorname);
